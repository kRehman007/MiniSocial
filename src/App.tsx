...
// const App = () => {
//   return (
//     <div className="flex flex-col gap-0 text-gray-700 leading-tight items-center justify-center w-screen h-screen">
//     <strong>Server Down...!</strong>
//     <p className="text-sm md:text-base">website not availabe...</p>
//     </div>
//   )
// }
